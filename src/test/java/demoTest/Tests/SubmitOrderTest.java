...
import demoTest.PageObject.OrderPage;
...
import demoTest.TestComponents.BaseTest;
	...
	public class SubmitOrderTest extends BaseTest{
		...
		{		
			List<HashMap<String,String>> data = getJsonDataToMap(System.getProperty("user.dir")+"//src//test//java//demoTest//data//PurchaseOrder.json");
